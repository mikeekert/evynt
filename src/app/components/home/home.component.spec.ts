...
describe('HomeComponent', () => {
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        { provide: EvyntService, useValue: spy}
      ]
    })
    .compileComponents();

    evyntServiceSpy = TestBed.get(EvyntService);
    evyntServiceSpy.getFeatured.and.returnValue({ subscribe: () => { } })
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(HomeComponent);
    component = fixture.componentInstance;
    carouselComponent = TestBed.createComponent(CarouselComponent).componentInstance;
